        ...
        var t = function(t, n, o) {
            var r = t,
                i = function(t, i, a, s) {
                    ...
                    p.style.width = "100%", p.style.height = "100%", i.prepend(p), "block" != e(i[0], "display") && i.css("display", "block"), e(i[0], "height").match(/^(0|auto)/) && i.css("height", "100%");
                    var u = function(e, r) {
                        ...
                        l = r.filter(a),
                        g = r.getOptions(l, t),
                        d = r.getControlOptions(l),
                        v = angular.extend(g, d),
                        f = r.getEvents(t, l);
            ...
            var n = e,
                o = function(e, o, r, i) {
                    var a = n.filter(r),
                        s = n.getOptions(a),
                        c = n.getEvents(e, a),
                        p = new google.maps.places.Autocomplete(o[0], s);
                    for (var u in c) google.maps.event.addListener(p, u, c[u]);
